...
class TestUserService(BaseTestCase):
  ...
  ########################################################
  # Get List Users Test Case
  #######################################################
  def test_all_users(self):
    add_user('michael', 'michael@mherman.org')
    add_user('fletcher', 'fletcher@notreal.com')
    add_user('eagles', 'eagles@gmail.com')
    ...
    with self.client:
      ...
      self.assertIn('eagles', data['data']['users'][2]['username'])
      self.assertIn('eagles@gmail.com', data['data']['users'][2]['email'])
      self.assertIn('success', data['status'])
